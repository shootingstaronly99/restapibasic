...
public class GiftCertificatesController {
    ...
    @GetMapping
    public ResponseEntity<List<GiftCertificates>> getAll() throws NullPointerException {
    ...
    @GetMapping(value = "/{id}")
    public ResponseEntity<Object> getById(@PathVariable int id) throws NullPointerException{
        ...
        if (giftCertificateOptional.isPresent()) {
            ...
            return ResponseHandler.generateResponse(ResponseMessage.FIND_BY_GIFT_ID_SUCCESS + id, HttpStatus.NOT_FOUND, "[]");
        }
    }
    ...
    public ResponseEntity<Object> create(@RequestBody GiftCertificates entity) throws NullPointerException{
    ...
    public ResponseEntity<Object> updateGiftCertificate(@PathVariable("id") int id, @RequestBody GiftCertificates giftCertificate) throws IncorrectParameterException,NullPointerException {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Object> delete(@PathVariable("id") Integer id) throws NullPointerException {
